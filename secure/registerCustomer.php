                    ...
                    <div class="card">
                        ...
                        <span class="input-group-addon">
                           <i class="material-icons">accessibility</i>
                                    ...
                                    <div class="form-line">
                                        <input  name="user" type="radio" id="customer" value="customer" checked/>
...
<!--                                        <label for="admin">Admin</label>-->
                                ...
                                <button class="btn btn-block btn-lg bg-pink waves-effect" type="submit">REGISTER CUSTOMER</button>
